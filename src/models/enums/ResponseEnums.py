...
class ResponseSignal(Enum):
    ...
    VECTOR_DB_INSERTION_ERROR = "vector_db_insertion_error"
    VECTOR_DB_SEARCH_SUCCESS = "vector_db_insertion_success"
    VECTOR_DB_SEARCH_ERROR = "vector_db_insertion_error"
